...
2. **Request Access**: Once you've opened the relevant Google Document, request access by clicking the **Share** button on the top right corner and clicking on the **Ask to share** button. Afterwards, enter your email on the 'Add people and groups' field and make sure **Editor** is set on the right. Then, click send.
![request editor access](/media/contributions-1.png)
**Alternatively**, you can contact [us](../introduction/about/#Contact) to get **editor** access to the relevant Google Documents. By default you should have commenter permissions.
...
1. **Click the Edit Button**: On every page, there should be a button on the bottom left that says *Edit this page on GitHub.* Click that.
2. **Fork the Repository**: Create a personal copy of the repository on GitHub.
3. **Clone Electronically**: Download the repository to your local machine.
4. **Create a Branch**: Always create a new branch for your changes (e.g., `feature/new-mechanism` or `fix/typo`).
5. **Commit Changes**: Provide clear, descriptive commit messages.
6. **Push and PR**: Push your branch to your fork and open a Pull Request (PR) against the `main` branch of the original repository.
7. **Code Review**: Participate in the review process and address any feedback provided by us.
